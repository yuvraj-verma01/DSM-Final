...
RELATIONSHIP_PAIRS = [
    ...
    ("ger_latest_ix_xii_avg", "dropout_secondary_pct", "How does latest ST GER relate to secondary dropout?"),
    ("gpi_ix_xii_avg", "employment_wpr_female_per_1000", "Does ST gender parity in enrolment relate to female work participation?"),
    (
        "scholarship_total_release_2023_24_lakh_per_100k_st_pop",
        "dropout_secondary_pct",
    ...
    (
        "ger_latest_ix_xii_avg",
        "mgnreg_work_100_plus_days_per_1000",
        "Do higher-GER states still show MGNREG 100-plus-days dependence?",
    ),
